...
export const UpdateCurrentYear = ({ refreshTrigger }: { refreshTrigger: number }) => {
    ...
    useEffect(() => {
        ...
        try {
          ...
          setAcademicYearID(result[0].academicYear_id || 0);
          setAcademicYear(result[0].academicYear || "");
          setAcademicYearStart(result[0].academicYearStart || "");
          setAcademicYearEnd(result[0].academicYearEnd || "");
          setIsLoading(false);
        } catch (error) {
...
/*************  ✨ Windsurf Command ⭐  *************/
    /**
     * Called when the confirmation dialog is canceled.
     * Displays a toast informing the user that the action was canceled.
     */
/*******  eee667dd-e540-460b-94f2-fcf8b22cd25d  *******/    },
