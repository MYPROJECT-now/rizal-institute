...
//           {!statusData?.hasTemptMonthly && statusData?.applicationFormReviewStatus === "Reserved" && (
...
//             </p>
//           ) :  
//           statusData?.hasTemptMonthly && statusData?.admissionStatus === "Pending" && statusData?.paymentStatus !== "Declined" && statusData?.paymentStatus !== "Pending" && statusData?.applicationFormReviewStatus === "Reserved"   ? (
