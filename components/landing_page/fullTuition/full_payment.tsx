...
import { getFullPaymentDataByTrackingId,  tuitionFeeRePayment } from "@/src/actions/landingPage";
...
import { RemarksModal } from "../landing_page_portal/full_payment_remarks/remarks_modal";




export const Full_TUition = () => {
    ...
    useEffect(() => {
        if (trackingId) {
            ...
            const fetchStudentData = async () => {
                try {
                    const data = await getFullPaymentDataByTrackingId(trackingId);
...
const validatePage = async (): Promise<boolean> => {
    ...
    const handleAdd = async () => {
        ...
        try {
            ...
            const uploadReservationReceipt = reservationReceipt ? await uploadImage(reservationReceipt, 'paymentReceipts') : "";
            ...
            const updatedStudent = await tuitionFeeRePayment(trackingId, updatedData);
            ...
            title: (
                <div>
                    <p className="text-[16px] md:text-2xl text-dGreen font-bold font-merriweather">
                        Section: Re-Payment of Tuition Fee
                    </p>
                </div>
                ),
            content: (
                    ...
                    <section className=" md:flex md:grid-cols-2 grid-cols-1 justify-center gap-5 pb-10 w-full">
                        ...
                        <div className="w-full md:w-1/2 flex flex-col items-center gap-10 mt-5 px-0 xl:px-10" >
                            ...
                            <Card className="w-full backdrop-blur-md bg-green-200/10 border border-green-300/20 shadow-lg rounded-2xl">
                                <CardHeader>
                                    <CardTitle className="text-dGreen text-center text-2xl underline font-merriweather font-extrabold">Step 1: Send the tuition fee</CardTitle>
                                </CardHeader>
    ...
    title: (
        ...
        <main className="w-full mt-10 flex flex-col items-center justify-center">
            ...
            <div className="h-full bg-gradient-to-r from-lGreen to-dGreen rounded-r-2xl flex flex-col items-center justify-center px-8 py-10 shadow-md">
                ...
                <p className="text-white text-2xl font-semibold mb-2 text-center tracking-wide">Your payment is almost complete!</p>
