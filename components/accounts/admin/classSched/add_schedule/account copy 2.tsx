        ...
        <div className="flex flex-col items-center gap-5">
          ...
          <div className="flex flex-col items-center pt-5 gap-5">
            ...
            <select
              ...
              value={selectedGradeLevel && selectedSection ? `${selectedGradeLevel}|${selectedSection}` : ""}
              className="border-2 border-gray-300 rounded px-3 py-1  w-full  focus:ring-1 focus:ring-dGreen focus:border-dGreen outline-none transition"
            >
              <option value="">-- Select Grade & Section --</option>
              {gradeSections
                .filter((gs) => assigned.some((a) => a.gradeLevel_id === gs.gradeLevel_id))
                .map((gs) => (
                  <option key={gs.section_id} value={`${gs.gradeLevel_id}|${gs.section_id}`}>
