  ...
  return (
      <div className="p-4 w-full min-h-screen lg:h-screen">
        <div className=" w-full h-full rounded-xl flex flex-col py-4 sm:px-10 px-4  bg-page">
          ...
          {/* <div className=" flex flex-col gap-4 items-center justify-center bg-gray-300  w-full mt-[60px] rounded-lg">
            <div className="flex flex-col text-start w-full px-10 ]">
