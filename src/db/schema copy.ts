  ...
  export const downPaymentRelations = relations(tempdownPaymentTable, ({ one }) => ({
    downPaymentTable: one(downPaymentTable, {
      fields: [tempdownPaymentTable.temp_down_id],
      references: [downPaymentTable.temp_down_id],
    })
  }))
  ...
  export const monthlyRelation = relations(TempMonthsInSoaTable, ({ one }) => ({
    temp_month: one(MonthsInSoaTable, {
      fields: [TempMonthsInSoaTable.temp_month_id],
      references: [MonthsInSoaTable.temp_month_id],
    }),
  })) 
...
export const AcademicYearRelations = relations(AcademicYearTable, ({ many }) => ({
  ...
  TempMonthsInSoaTable: many(TempMonthsInSoaTable),
