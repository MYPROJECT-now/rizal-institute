...
//   // Outstanding balance calculation up to this month
//   let outstandingBalance = 0;
//   if (info) {
//     // Get student_id from StudentInfoTable
...
//       // Sum remaining balance for months up to and including current month
//       for (const month of allMonths) {
//         // Try to parse month name to month index (0-based)
//         let monthIndex = -1;
//         try {
//           monthIndex = new Date(Date.parse(month.month + ' 1, 2000')).getMonth();
//         } catch {}
//         // Only include months up to and including the current month
//         if ((monthIndex !== -1 && monthIndex <= currentMonth) || monthIndex === -1) {
//           const remaining = month.monthlyDue - month.amountPaid;
//           if (remaining > 0) {
...
//   console.log("Outstanding Balance (up to this month):", outstandingBalance);
